...
以下為參考專案——每一個都記錄了「我如何思考、工作」，而不只是「做了什麼」：包含決策過程、權衡取捨，工具、以及維運面的考量。

| Repository                                                                                       | 展示內容                                                                                                                                                  |
| ------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🧠 [**engineering-hub**](https://github.com/JHying/engineering-hub)                              | SDLC 多角色跨專案 AI 工程協作庫，基於 SA、Backend、QA、SRE、PM 與 Reviewer agent 等各自角色的工作流，針對同一個 story 協同工作，除了將軟體從開發、review 到測試的流程自動化，也內建自動 KB 建立機制，讓專案知識得以持續累積，而非隨時間流失。 |
...
Reference projects — each one documents *how I reason and implement*, not just what was built: the decisions, the trade-offs, tool, and the operational considerations.

| Repository                                                                                       | What it shows                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🧠 [**engineering-hub**](https://github.com/JHying/engineering-hub)                              | A SDLC multi-role AI engineering collaboration framework, where SA, Backend, QA, SRE, PM, and Reviewer agents work through role-specific workflows on the same story. Beyond automating the flow from development and review through testing, it includes an automatic KB-building mechanism so project knowledge compounds rather than decays. |
